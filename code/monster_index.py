...
class MonsterIndex:
    ...
    def display_main(self,dt):
        ...
        # Nível
        level_surf = self.fonts['regular'].render(f'{monster.level}', False, COLORS['white'])
        ...
        draw_bar(self.display_surface, energybar_rect, monster.energy, monster.get_stat('max_health'), COLORS['blue'], COLORS['black'], 2)
